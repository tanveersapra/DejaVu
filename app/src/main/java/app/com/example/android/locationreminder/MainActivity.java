...
<<<<<<< HEAD
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		notedb.execSQL("create table if not exists alarm(id integer,  Date text, hour integer, minutes integer, foreign key(id) references base(id));");
...
=======
    ...
    public void new_note(View view) {
        //Toast.makeText(this,"You clicked on the plus sign",Toast.LENGTH_SHORT).show();
        view.showContextMenu();
>>>>>>> 499351dfc3b5319056e656b00213c7053b15b8ee
